...
{
    public partial class SCodeRegisteDlg : Form
    {
        ...
        public SCodeRegisteDlg()
        {
            InitializeComponent();
        }

        private void SCodeRegisteDlg_Load(object sender, EventArgs e)
        {
        ...
        private void btnOk_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (WorkingMode.Equals("STAFF"))
                {
                    ...
                    result = MyHttpUtils.HttpPost(baseUrl + "/IAdapter/RegisteScanCodeByStaffer", sbody);
                }
                else
                {
                    ...
                    result = MyHttpUtils.HttpPost(baseUrl + "/IAdapter/RegisteScanCodeByService", sbody);
                }
