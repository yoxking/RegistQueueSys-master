...
{
  public class StafferRotaDAL: IStafferRota
  {
        #region sql
        private const string SQL_GET_ALL_RECORDS = @"Select *  From StafferRota Where AppCode like @AppCode And ValidityState=1";
        private const string SQL_GET_RECORDS_BY_NO = @"Select * From StafferRota Where   AppCode like @AppCode And   ValidityState=1 And RotaNo=@RotaNo";
        private const string SQL_GET_NAME_BY_NO = @"Select Name From StafferRota Where   AppCode like @AppCode And   ValidityState=1 And RotaNo=@RotaNo";
        private const string SQL_ADD_RECORD = @"Insert into StafferRota
                                              (RotaNo,StafferNo,RotaType,StartDate,EnditDate,WeekDay1,WeekDay2,WeekDay3,WeekDay4,WeekDay5,WeekDay6,WeekDay7,RotaFormat,RegisteFees,BranchNo,AddOptor,AddDate,ModOptor,ModDate,ValidityState,Comments,AppCode)
                                              values(@RotaNo,@StafferNo,@RotaType,@StartDate,@EnditDate,@WeekDay1,@WeekDay2,@WeekDay3,@WeekDay4,@WeekDay5,@WeekDay6,@WeekDay7,@RotaFormat,@RegisteFees,@BranchNo,@AddOptor,@AddDate,@ModOptor,@ModDate,@ValidityState,@Comments,@AppCode)";
        private const string SQL_UPDATE_RECORD = @"Update StafferRota set
                                                 RotaNo=@RotaNo,StafferNo=@StafferNo,RotaType=@RotaType,StartDate=@StartDate,EnditDate=@EnditDate,WeekDay1=@WeekDay1,WeekDay2=@WeekDay2,WeekDay3=@WeekDay3,WeekDay4=@WeekDay4,WeekDay5=@WeekDay5,WeekDay6=@WeekDay6,WeekDay7=@WeekDay7,RotaFormat=@RotaFormat,RegisteFees=@RegisteFees,BranchNo=@BranchNo,AddOptor=@AddOptor,AddDate=@AddDate,ModOptor=@ModOptor,ModDate=@ModDate,ValidityState=@ValidityState,Comments=@Comments,AppCode=@AppCode 
                                                 Where  AppCode like @AppCode And   ValidityState=1 And RotaNo=@RotaNo  And Version=@Version";
        private const string SQL_HARD_DELETE_RECORD = @"Delete From StafferRota Where   AppCode like @AppCode And   RotaNo=@RotaNo ";
        private const string SQL_SOFT_DELETE_RECORD = @"Update StafferRota set ValidityState=0 Where   AppCode like @AppCode And   ValidityState=1 And RotaNo=@RotaNo";
        private const string SQL_HARD_DELETE_BY_CONDTION = @"Delete From StafferRota Where   AppCode like @AppCode ";
        private const string SQL_SOFT_DELETE_BY_CONDTION = @"Update StafferRota set ValidityState=0 Where   AppCode like @AppCode And   ValidityState=1 ";
        private const string SQL_GET_RECORDS_BY_CLASSNO = @"Select * From StafferRota Where    AppCode like @AppCode And   ValidityState=1 And StafferNo=@StafferNo";
        private const string SQL_GET_COUNT_BY_CONDITION = @"Select Count(*) From StafferRota Where   AppCode like @AppCode  And   ValidityState=1 ";
        #endregion
        ...
        public StafferRotaDAL(string sConnStr,string sAppCode)
        {
           this.connStr = sConnStr;
           this.appCode = sAppCode;
        }

        public StafferRotaCollections GetAllRecords()
        {
            SqlConnection connection = null;
            SqlDataReader reader = null;
            StafferRotaCollections infos = null;
            StafferRota info = null;
            ...
            try
            {
                ...
                if (reader.HasRows)
                {
                    infos = new StafferRotaCollections();
                    while (reader.Read())
                    {
        ...
        public StafferRotaCollections GetRecordsByClassNo(string sClassNo)
        {
            SqlConnection connection = null;
            SqlDataReader reader = null;
            StafferRotaCollections infos = null;
        ...
        public StafferRotaCollections GetRecordsByNo(string sNo)
        {
            SqlConnection connection = null;
            SqlDataReader reader = null;
            StafferRotaCollections infos = null;
        ...
        public int AddNewRecord(StafferRota info)
        {
            SqlConnection connection = null;
        ...
        public int UpdateRecord(StafferRota info)
        {
            SqlConnection connection = null;
  ...
  catch (Exception ex)
 {
  ...
  finally
  {
     if (connection != null)
        ...
        public StafferRotaCollections GetRecords_Paging(SqlModel s_model)
        {
            SqlConnection connection = null;
            SqlDataReader reader = null;
            StafferRotaCollections infos = null;
       ...
       /// <param name=" obj_info">主题对象</param>
        ...
        internal static void PutObjectProperty(StafferRota obj_info, SqlDataReader reader)
        {
