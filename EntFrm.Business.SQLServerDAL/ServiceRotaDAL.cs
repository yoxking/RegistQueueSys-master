...
namespace EntFrm.Business.SQLServerDAL
{
  public class ServiceRotaDAL: IServiceRota
  {
        ...
        private const string SQL_ADD_RECORD = @"Insert into ServiceRota
                                              (RotaNo,ServiceNo,RotaType,StartDate,EnditDate,WeekDay1,WeekDay2,WeekDay3,WeekDay4,WeekDay5,WeekDay6,WeekDay7,RotaFormat,RegisteFees,BranchNo,AddOptor,AddDate,ModOptor,ModDate,ValidityState,Comments,AppCode)
                                              values(@RotaNo,@ServiceNo,@RotaType,@StartDate,@EnditDate,@WeekDay1,@WeekDay2,@WeekDay3,@WeekDay4,@WeekDay5,@WeekDay6,@WeekDay7,@RotaFormat,@RegisteFees,@BranchNo,@AddOptor,@AddDate,@ModOptor,@ModDate,@ValidityState,@Comments,@AppCode)";
