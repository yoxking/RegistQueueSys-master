...
namespace EntWeb.HDeptConsole.Areas.StaffData.Controllers
{
    public class MainFrameController : frmMainController
    {
        public MainFrameController()
        {
            ...
            viewExpress.ViewTag = "StaffMFrame";
        ...
        public ActionResult Index()
        {
            ...
            {
                return RedirectToAction("Index", "MainFrame", new { Area = "ServData" });
            }
        }
        ...
        {
            ViewBag.InfoList = PageService.GetStaffList();
            return View();
        }
        ...
        { 
            ViewBag.StaffList = PageService.GetStaffList();
        ...
        //分诊
        public ActionResult doSetTriage(string ids,string StafferNo)
        {
            try
            {
                ProcessFlowsBLL infoBLL = new ProcessFlowsBLL(PublicHelper.Get_ConnStr(), PublicHelper.Get_AppCode());
        ...
        //转诊
        public ActionResult doSetExchange(string ids, string StafferNo)
        {
            try
            {
                ProcessFlowsBLL infoBLL = new ProcessFlowsBLL(PublicHelper.Get_ConnStr(), PublicHelper.Get_AppCode());
            ...
            try
            {
                ...
                foreach (string id in idArr)
                {
                    ...
                    if (info != null)
                    {
                        ...
                        //{
                        //    BusinessHelper.UpdateShowState(info.sServiceNo, info.sStafferNo);
                        //}
                    }
                }
        ...
        #region  未报到人员操作
        //手工录入
        public ActionResult doUpdateRUser(string StafferNo, string workTime, string ruserName, string ruserSex, string idNo,string age, string telphone)
        {
            try
            {
                string ticketNo = "";
                ...
                {
                    ticketNo = BusinessHelper.EnqueueRegistUser(info, "", StafferNo);

                    PrintTicket(PageService.GetStafferName(info.sStafferNo) + ticketNo);
            ...
            try
            {
                ...
                foreach (string id in idArr)
                {
                    ...
                    if (info != null)
                    {
                        ...
                        PrintTicket(PageService.GetStafferName(StafferNo) + ticketNo);
                    }
                }
