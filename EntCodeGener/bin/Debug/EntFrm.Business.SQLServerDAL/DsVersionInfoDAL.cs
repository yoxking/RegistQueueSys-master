...
namespace EntFrm.Business.SQLServerDAL
{
  public class DsVersionInfoDAL: IDsVersionInfo
  {
        ...
        private const string SQL_GET_NAME_BY_NO = @"Select Name From DsVersionInfo Where   AppCode like @AppCode And   ValidityState=1 And VerNo=@VerNo";
        ...
        private const string SQL_GET_RECORDS_BY_CLASSNO = @"Select * From DsVersionInfo Where    AppCode like @AppCode And   ValidityState=1 And ClassNo=@ClassNo";
     ...
     if (connection != null)
       ...
       /// <param name=" obj_info">主题对象</param>
        ...
        internal static void PutObjectProperty(DsVersionInfo obj_info, SqlDataReader reader)
        {
            ...
            obj_info.sVersion= StringHelper.ConvertToString((byte[])reader["Version"].ToString());
        }
        #endregion
    }
}
