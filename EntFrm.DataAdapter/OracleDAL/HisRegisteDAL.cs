...
{
    public class HisRegisteDAL
    {
        #region sql
        private const string SQL_GET_ALL_RECORDS = @"Select *  From view_registerinfo ";
        private const string SQL_GET_RECORD_BY_NO = @"Select * From view_registerinfo Where outpatient_id=:RegistId";
        private const string SQL_GET_NAME_BY_NO = @"Select patient_name From view_registerinfo Where outpatient_id=:RegistId";
        private const string SQL_GET_RECORDS_BY_CLASSNO = @"Select * From view_registerinfo Where pay_flag=:PatType ";
        private const string SQL_GET_COUNT_BY_CONDITION = @"Select Count(*) From view_registerinfo Where 1=1 ";
        #endregion
        ...
        public HisRegisteDAL(string sConnectionStr)
        {
        ...
        public List<HisPatientInfo> GetRecordsByClassNo(string sClassNo)
        {
            ...
            try
            {
                ...
                {
                    new OracleParameter(PARAM_PATTYPE,OracleDbType.NVarchar2,50)
                };
        ...
        public HisPatientInfo GetRecordByNo(string sNo)
        {
            ...
            try
            {
                OracleParameter[] paras = new OracleParameter[]
                {
                    new OracleParameter(PARAM_REGISTID,OracleDbType.NVarchar2,50)
                };
                paras[0].Value = sNo;
        ...
        public List<HisPatientInfo> GetRecordsByPaging(int pageIndex, int pageSize, string condition)
        {
            ...
            try
            {
                ...
                s_model.sTableName = "view_registerinfo";
        ...
        internal static void PutObjectProperty(HisPatientInfo obj_info, OracleDataReader reader)
        {
            ...
            obj_info.PatType = reader["pay_flag"].ToString().Trim();
            obj_info.Status = "Y";
            obj_info.Remark = "";
        }
        #endregion
