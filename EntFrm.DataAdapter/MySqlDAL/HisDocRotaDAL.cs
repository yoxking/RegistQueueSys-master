    ...
    public class HisDocRotaDAL
    {
        ...
        public List<HisDoctorRota> GetRecordsByClassNo1(string sClassNo)
        {
            ...
            try
            {
                ...
                connection = MylHelper.GetConnection(connectionStr);
                reader = MylHelper.ExecuteReader(connection, CommandType.Text, SQL_GET_RECORDS_BY_CLASSNO1, paras);
        ...
        public List<HisDoctorRota> GetRecordsByClassNo2(string sClassNo)
        {
            ...
            try
            {
                MySqlParameter[] paras = new MySqlParameter[]
                {
                    new MySqlParameter(PARAM_DOCTORID,MySqlDbType.VarChar,50)
                };
                paras[0].Value = sClassNo;

                connection = MylHelper.GetConnection(connectionStr);
                reader = MylHelper.ExecuteReader(connection, CommandType.Text, SQL_GET_RECORDS_BY_CLASSNO2, paras);
        ...
        public HisDoctorRota GetRecordByNo(string sNo)
        {
            ...
            try
            {
                MySqlParameter[] paras = new MySqlParameter[]
                {
                    new MySqlParameter(PARAM_ID,MySqlDbType.VarChar,50)
                };
                paras[0].Value = sNo;
        ...
        internal static void PutObjectProperty(HisDoctorRota obj_info, MySqlDataReader reader)
        {
