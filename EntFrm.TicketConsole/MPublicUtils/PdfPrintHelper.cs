...
namespace EntFrm.TicketConsole.MPublicUtils
{
    public class PdfPrintHelper
    {
        ...
        public PdfPrintHelper(string type)
        {
            SetPageSize(type);
            document = new Document(rect);
        }
        ...
        public PdfPrintHelper(string type, float marginLeft, float marginRight, float marginTop, float marginBottom)
        {
            SetPageSize(type);
        ...
        public void AddTable(DataTable dtSource, float fontsize)
        {
            SetFont(fontsize);
            ...
            float[] widths = new float[] { 115f, 75f, 35f, 35f, 30f, 110f };
